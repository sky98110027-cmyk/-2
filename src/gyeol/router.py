...
- deep : 레퍼런스를 프레임 단위로, 화면까지 뜯어달라고 할 때.
         "화면까지 뜯어줘", "프레임 단위로 봐줘", "캐릭터 어디 뜨는지 봐줘".
- voice : 나레이션을 목소리로 읽어달라고 할 때. "목소리 입혀줘", "읽어줘".
- assemble : 재료를 묶어서 영상 파일로 만들어달라고 할 때. "조립해줘", "영상으로 뽑아줘", "mp4 로".
